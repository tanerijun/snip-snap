...
import (
	...
	"github.com/tanerijun/snip-snap/internal/validator"
)
...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
	defaultFormData := snippetCreateForm{
		Expires: 365,
	}
	data.Form = defaultFormData
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.RxEmail), "email", "This field must be a valid email address")
